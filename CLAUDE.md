...
`ROADMAP.md` holds the sequence, the corrections to earlier assumptions, and the
list of deliberately rejected ideas. **Read it before re-litigating a decision.**
